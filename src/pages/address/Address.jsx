...
import address2 from "../../assets/images/address2.jpg";
...
function Address() {
  ...
  const handleCreateAddress = async () => {
    if (!selectedProvince || !city || !block || !street || !house) {
  ...
  return (
    <div className="flex  bg-gray-100 3xl:items-center  lg:overflow-hidden h-screen   flex-col  lg:flex-row justify-around  ">
      ...
      <div className=" rounded-2xl py-10  px-10 ">
        <div className="  flex flex-col  lg:w-[500px]">
          ...
          <div className="mb-5">
            <h1 className="font-bold text-md mb-2">Province:</h1>
            <select
